...
OUTPUT_DIR = BASE_DIR / "nonebot_plugin_arkguesser" / "resources" / "illustrations"

# 干员数据文件路径
CHARACTERS_CSV_PATH = BASE_DIR / "nonebot_plugin_arkguesser" / "resources" / "data" / "characters.csv"
